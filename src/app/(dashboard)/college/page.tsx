    ...
    <div className="min-h-screen bg-gray-100 p-8 relative">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="ml-4 px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-600 transition"
        >
          Add Faculty
        </button>
      </div>
        ...
        {filteredFaculty.map((prof) => (
          ...
          >
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-600 transition"
            >
              Details
            </button>
          </div>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 px-10 py-4 bg-red-600 text-white rounded-lg shadow-md hover:bg-red-600 transition"
      >
        Logout
      </button>
    </div>
