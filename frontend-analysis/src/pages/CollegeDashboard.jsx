...
export default function CollegeDashboard({ faculty, addFaculty }) {
  ...
  const goToAddFaculty = () => {
    navigate("/add-faculty", { state: { faculty } });
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 relative">
      ...
      {/* Header with Title + Add Faculty button */}
      ...
      <div className="flex justify-center">
        <div className="bg-white shadow-md rounded-xl p-6 mb-10 w-full sm:w-2/3 lg:w-1/2 text-center">
          ...
          <p>
            ...
            {lastAttendance.faculty}
          </p>
          <p>
            <span className="font-semibold">Year & Branch:</span>{" "}
            {lastAttendance.yearBranch}
          </p>
          <p>
            <span className="font-semibold">Subject:</span>{" "}
            {lastAttendance.subject}
          </p>
          <p>
      ...
      <div className="flex justify-center mb-6 gap-3">
        <input
          ...
          className="w-180 px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
